// NPRCharacter/NPRCharacterVertex.hlsl
// 顶点着色器,对应原始 asm VS 0-183(skin/face 与 cloth 逐字节相同)。
// - 压缩法线/切线解码(asm 0-42):_CHARACTER_PACKED_NORMALS 关键字控制(默认关,Unity 顶点流无 30bit uint 精度)
...
#ifndef NPRCHARACTER_VERTEX_INCLUDED
#define NPRCHARACTER_VERTEX_INCLUDED
...
CharacterVaryings CharacterVert(CharacterAttributes input)
{
...
#if defined(_CHARACTER_PACKED_NORMALS)
    ...
    // 切线符号乘积(asm 178 + PS asm 44-48:sign(v3.w) * sign(cb1[inst+5].w))
...
#endif // NPRCHARACTER_VERTEX_INCLUDED
